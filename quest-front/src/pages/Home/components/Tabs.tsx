          ...
          <button
            ...
            className={cn(
              ...
              isActive
                ...
                : 'color-gray border-gray hover:text-dark-gray hover:bg-accent hover:border-accent hover:shadow-none bg-[rgba(217,217,217,0.1)] shadow-[0px_4px_8px_-4px_#FFFFFF40_inset,0px_-4px_8px_-4px_#FFFFFF40_inset]'
            )}
          >
            {button}
          </button>
