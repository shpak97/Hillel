...
import { PasswordResetEmailRequestDto } from './dto/password-reset-email.dto';
...
export class AuthController {
  ...
  async refreshAccessToken(
    ...
    await this.authService.refreshAccessToken(refreshAccessTokenRequestDto);
  }
  @Post('password-reset-email')
  async passwordResetEmail(
    @Body() passwordResetEmailRequestDto: PasswordResetEmailRequestDto,
  ) {
    await this.authService.passwordResetEmail(passwordResetEmailRequestDto);
  }
  @Post('password-reset')
  async passwordReset(
    @Body() passwordResetRequestDto: PasswordResetRequestDto,
  ) {
    await this.authService.passwordReset(passwordResetRequestDto);
  }
