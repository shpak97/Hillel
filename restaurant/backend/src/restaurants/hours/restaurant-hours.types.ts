import type { RestaurantHours } from '@prisma/client';

export type RestaurantTimezoneRow = { timezone: string } | null;

export type HoursRecord = RestaurantHours;
...
export type RestaurantHoursResponse = {
  timezone: string;
