...
export default async function RestaurantMenusPage({ params }: MenusPageProps) {
    ...
    >
      <div className="mb-6">
        ...
        <p className="mt-4 text-[16px] font-semibold leading-7 text-ink-600">
          Керування меню, фото та розкладом доступності.
        </p>
      </div>

      <MenuList restaurantUuid={uuid} menus={menus} />
    </AdminLayout>
  );
}
